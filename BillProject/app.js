...
app.post("/buyers", (req, res) => {
    try {
        ...
        if (savedBuyer.changes != 1) {
            return res.status(501).json({ message: "Buyer save failed" });
        }
...
app.put("/buyers/:id", (req, res) => {
    try {
        ...
        if (updatedBuyer.changes != 1) {
            return res.status(501).json({ message: "Buyer update failed" });
        }
...
app.delete("/buyers/:id", (req, res) => {
    try {
        ...
        if (deletedBuyer.changes != 1) {
            return res.status(501).json({ message: "Buyer delete failed" });
        }
...
app.post("/sellers", (req, res) => {
    try {
        ...
        if (savedSeller.changes != 1) {
            return res.status(501).json({ message: "Seller save failed" });
        }
...
app.put("/sellers/:id", (req, res) => {
    try {
        ...
        if (updatedSeller.changes != 1) {
            return res.status(501).json({ message: "Seller update failed" });
        }
        res.status(200).json({ id, name, address, taxNumber });
    }
    catch (err) {
...
app.delete("/sellers/:id", (req, res) => {
    try {
        ...
        if (deletedSeller.changes != 1) {
            return res.status(501).json({ message: "Seller delete failed" });
        }
        res.status(200).json({ message: "Delete successfull!" });
    }
    catch (err) {
...
app.post("/bills", (req, res) => {
    try {
        ...
        if (savedBill.changes != 1) {
            return res.status(501).json({ message: "Bill save failed" });
        }
...
app.delete("/bills/:id", (req, res) => {
    try {
        ...
        if (deleteBill.changes != 1) {
            return res.status(501).json({ message: "Bill delete failed" });
        }
        res.status(200).json({ message: "Delete successfull!" });
    }
    catch (err) {
